				...
				<div class='panel panel-info'>
                    ...
                    <div class="card-footer small text-muted form-group">
						*) Wajib diisi
						...
						<form action="<?php base_url('admin/edit_tugas') ?>" method="post" enctype="multipart/form-data" >
                        ...
                        <input type="hidden" name='nip' value='<?php echo $this->session->userdata('ses_id'); ?>'>
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="old_image" value="<?php echo $tugas->pic_soal ?>" />
							</div>

							<div class="form-group">
								<label for="name">Materi*</label>
                                <input type='text' class="form-control1 <?php echo form_error('materi') ? 'is-invalid':'' ?> " name='materi' value='<?php echo $tugas->materi?>'>
